...
SERVICE_EXEC_NODE="WorkingDirectory=/www/dist\nExecStart=/usr/bin/nodejs server.js --port 80 --contract-shuffle $ADDR_SHUFFLE --contract-dice $ADDR_DICE --contract-fifty $ADDR_FIFTY --contract-lottery $ADDR_LOTTERY"
